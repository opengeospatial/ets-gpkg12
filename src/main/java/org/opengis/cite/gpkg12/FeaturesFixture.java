...
public class FeaturesFixture extends CommonFixture {
	...
	protected static final Collection<String> ALLOWED_GEOMETRY_TYPES = Arrays.asList(geomGEOMETRY, geomPOINT,
			geomLINESTRING, geomPOLYGON, geomMULTIPOINT, geomMULTILINESTRING, geomMULTIPOLYGON, geomGEOMETRYCOLLECTION);
