 ...
 * </p>
 * <ul>
 * <li><a href="http://docs.opengeospatial.org/is/18-000/18-000.html#f_rc" target=
 * "_blank"> GeoPackage Related Tables Extension, Related Features Requirements Class</a>
 * (OGC 18-000)</li>
 * </ul>
 *
 * @author Jeff Yutzler
...
public class FeaturesTests extends RTEBase {
	...
	/**
	 * A user-defined related data table or view SHALL be a user-defined features table or
	 * view if the row in gpkgext_relations with a corresponding related_table_name has a
	 * relation_name of "features".
	...
	/**
	 * A user-defined related features table or view SHALL be a GPKG vector feature table
	 * type.
	 * @throws SQLException On any SQL query error or test failure
	 *
