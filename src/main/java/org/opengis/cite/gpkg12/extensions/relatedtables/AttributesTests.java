 ...
 * </p>
 * <ul>
 * <li><a href="http://docs.opengeospatial.org/is/18-000/18-000.html#attr_rc" target=
 * "_blank"> GeoPackage Related Tables Extension, Related Attributes Requirements
 * Class</a> (OGC 18-000)</li>
 * </ul>
 *
 * @author Jeff Yutzler
 */
public class AttributesTests extends RTEBase {
	...
	/**
	 * A user-defined related data table or view SHALL be a user-defined related
	 * attributes table or view if the row in gpkgext_relations with a corresponding
	 * related_table_name has a relation_name of "attributes".
	...
	/**
	 * A user-defined related attributes table or view SHALL be a GPKG attributes table
	 * type.
	 * @throws SQLException On any SQL query error or test failure
	 *
